...
call_user_func(function() {
    ...
    if (!function_exists('intl_get_error_code')) {
        require_once SNAPDIR . '/vendor/symfony/symfony/src/Symfony/Component/Locale/Resources/stubs/functions.php';

        $loader->add('', SNAPDIR . '/vendor/symfony/symfony/src/Symfony/Component/Locale/Resources/stubs');
    }
